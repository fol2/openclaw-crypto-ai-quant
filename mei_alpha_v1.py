...
#   dev/ai_quant/quant_trader_v5/run_unified_daemon.py
#
...
#   dev/ai_quant/strategy_overrides.toml
STRATEGY_YAML_PATH = os.getenv("AI_QUANT_STRATEGY_YAML", os.path.join(_THIS_DIR, "strategy_overrides.yaml"))
STRATEGY_TOML_PATH = os.getenv("AI_QUANT_STRATEGY_TOML", os.path.join(_THIS_DIR, "strategy_overrides.toml"))
...
try:
    ...
    try:
        from quant_trader_v5.strategy_manager import StrategyManager as _QTStrategyManager
    except Exception:
        try:
    ...
    def get_live_balance(self):
        ...
        try:
            ...
            def _get_rest_mids() -> dict[str, float]:
                ...
                try:
                    from quant_trader_v5.hyperliquid_rest import HyperliquidRestClient
