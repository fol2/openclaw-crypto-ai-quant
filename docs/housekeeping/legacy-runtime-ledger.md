...
|---|---|---|---|
| Python daemon orchestration | `engine/daemon.py`, `engine/core.py` | Active, frozen (paired opt-in Rust paper daemon wrapper with refreshable watchlist file polling; no cutover) | `aiq-runtime paper daemon` |
