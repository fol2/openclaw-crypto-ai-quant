...
|---|---|---|---|
| Python daemon orchestration | `engine/daemon.py`, `engine/core.py` | Active, frozen (paired opt-in Rust paper daemon with daemon-owned watchlist reload and outer scheduler; no cutover) | `aiq-runtime paper daemon` |
