...
- the emitted `daemon_command` is the exact Rust paper daemon launch contract for the current effective env/CLI combination; it is intended for operator review, not as evidence of cutover
