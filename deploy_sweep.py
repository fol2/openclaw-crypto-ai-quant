...
YAML_PATH = os.path.join(SCRIPT_DIR, "strategy_overrides.yaml")
CHANGELOG_PATH = os.path.join(SCRIPT_DIR, "strategy_changelog.json")
PAPER_DB = os.path.join(SCRIPT_DIR, "trading_engine.db")
LIVE_DB = os.path.join(SCRIPT_DIR, "trading_engine_live.db")
