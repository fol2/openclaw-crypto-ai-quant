...
Used by the unified daemon (`python -m quant_trader_v5.run_unified_daemon`) when
...
def run_trader():
    raise SystemExit(
        "Deprecated: use `python -m quant_trader_v5.run_unified_daemon` "
