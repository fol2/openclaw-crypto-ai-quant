...
fn random_gpu_combo_config(rng: &mut StdRng) -> GpuComboConfig {
    GpuComboConfig {
        ...
        exit_order_0: bt_gpu::buffers::GPU_EXIT_ORDER_ID_STOP_LOSS_ASE,
        exit_order_1: bt_gpu::buffers::GPU_EXIT_ORDER_ID_STOP_LOSS_DASE,
        exit_order_2: bt_gpu::buffers::GPU_EXIT_ORDER_ID_STOP_LOSS_SLB,
        exit_order_3: bt_gpu::buffers::GPU_EXIT_ORDER_ID_STOP_LOSS_BASE,
        exit_order_4: bt_gpu::buffers::GPU_EXIT_ORDER_ID_STOP_LOSS_BREAKEVEN,
        exit_order_5: bt_gpu::buffers::GPU_EXIT_ORDER_ID_TRAILING_LOW_CONF_OVERRIDE,
        exit_order_6: bt_gpu::buffers::GPU_EXIT_ORDER_ID_TRAILING_VOL_BUFFER,
        exit_order_7: bt_gpu::buffers::GPU_EXIT_ORDER_ID_TRAILING_BASE,
        exit_order_8: bt_gpu::buffers::GPU_EXIT_ORDER_ID_TAKE_PROFIT_PARTIAL,
        exit_order_9: bt_gpu::buffers::GPU_EXIT_ORDER_ID_TAKE_PROFIT_FULL,
        exit_order_10: bt_gpu::buffers::GPU_EXIT_ORDER_ID_SMART_TREND_BREAKDOWN,
        exit_order_11: bt_gpu::buffers::GPU_EXIT_ORDER_ID_SMART_TREND_EXHAUSTION,
        exit_order_12: bt_gpu::buffers::GPU_EXIT_ORDER_ID_SMART_EMA_MACRO_BREAKDOWN,
        exit_order_13: bt_gpu::buffers::GPU_EXIT_ORDER_ID_SMART_STAGNATION,
        exit_order_14: bt_gpu::buffers::GPU_EXIT_ORDER_ID_SMART_FUNDING_HEADWIND,
        exit_order_15: bt_gpu::buffers::GPU_EXIT_ORDER_ID_SMART_TSME,
        exit_order_16: bt_gpu::buffers::GPU_EXIT_ORDER_ID_SMART_MMDE,
        exit_order_17: bt_gpu::buffers::GPU_EXIT_ORDER_ID_SMART_RSI_OVEREXTENSION,
    }
}
